...
const FormikInput = ({ label, ...props }) => {
    ...
    return (
        <>
            <div className="relative h-20 rounded-sm  bg-gray-200 w-full  min-w-[200px]">
                <input
                    {...field}
                    {...props}
